...
<head>
  ...
  <!-- Icons -->
  <link href="cc/plantilla.css" rel="stylesheet">
</head>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  <header class="app-header navbar">
    ...
    <a class="fa " href="#"><h4>COMERCIO</h4></a>
      ...
      <nav class="sidebar-nav">
        <ul class="nav">
          ...
          <li class="nav-item nav-dropdown">
            <a class="nav-link " href="#"><i class="icon-user"></i> Persona</a>
            <!--
  ...
  <footer class="app-footer">
    <span>Universidad Politécnica de Victoria</span>
    <span class="ml-auto">Desarrollado por Héctor De La Fuente</span>
  </footer>
